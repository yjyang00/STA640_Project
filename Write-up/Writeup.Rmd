...
In addition, we also considered the potential interaction effect from unmeasured confounding and treatment on the outcome. There are three 



The outcome variable, $Y_it$, is thus continuous and generated from a linear model including: 
